...
const AboutHero = () => {
  return (
    <section className='min-h-[calc(100vh-192px)] flex flex-col space-y-10 items-center justify-center'>
        <motion.div 
        ...
        >
          ...
          >
            <h2 className='text-5xl font-semibold text-center text-white mb-6'>
              Innovation, Collaboration, and Purpose-Driven Impact
            </h2>
            <p className='text-lg text-[#F8F8F8]/70 text-center max-w-5xl mx-auto'>
